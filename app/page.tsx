...
export default function GamePage() {
  ...
  React.useEffect(() => {
    const handleKeyDown = (e: KeyboardEvent) => {
      if (e.code === 'Space' && game.isSelecting && game.selectedCards.length > 0) {
        e.preventDefault();
        handlePlayCards();
      }
    };
      ...
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-green-700 to-green-900 p-4">
        <div className="flex flex-col items-center gap-6 rounded-xl bg-white p-8 shadow-2xl">
          ...
          <div className="w-full rounded-lg bg-gray-50 p-4">
            <h3 className="mb-3 text-lg font-semibold text-gray-700">Final Scores:</h3>
              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {player.hand.map((card) => {
                    const animState = animations.getCardAnimationState(card.id);
